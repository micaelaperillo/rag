        ...
        <div className="space-y-6">
          ...
          {isLoading && (
            <div className="flex items-center justify-center py-12">
              ...
              <span className="ml-2 text-muted-foreground">Finding the perfect videos for you...</span>
            </div>
          )}
              ...
              {recommendations.recommendations.map((recommendation: any, index: number) => {
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    ...
                    {/* AI Reasoning */}
                    <div className="md:w-80 p-6 border-l border-white/10 bg-gradient-to-br from-primary/5 to-accent/5">
          ...
          {/* No Results */}
          {hasSearched && recommendations && (!recommendations.recommendations || recommendations.recommendations.length === 0) && !isLoading && (
            <div className="glass-card rounded-2xl p-6 text-center">
